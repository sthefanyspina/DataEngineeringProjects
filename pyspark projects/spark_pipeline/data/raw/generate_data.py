...
sales.to_csv("data/raw/Sales_Identification.csv", index=False)
...
products.to_csv("data/raw/Product_Data.csv", index=False)
...
transactions.to_csv("data/raw/Transaction_Details.csv", index=False)
...
delivery.to_csv("data/raw/Logistics_Delivery.csv", index=False)
...
sellers.to_csv("data/raw/Seller_Operation_Info.csv", index=False)
...
financial.to_csv("data/raw/Advanced_Financial_Data.csv", index=False)
